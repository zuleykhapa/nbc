...
Latest run: [ Run Link ](https://github.com/duckdb/duckdb/actions/runs/13847337229)
...
##### ['delta', 'sqlite_scanner', 'excel', 'inet', 'vss', 'tpcds', 'httpfs', 'fts', 'arrow', 'postgres_scanner', 'mysql_scanner', 'azure', 'tpch', 'spatial', 'iceberg', 'aws']
...
#### Tested extensions
The following extensions could be loaded and installed successfully:
##### ['tpch', 'spatial', 'aws', 'mysql_scanner', 'azure', 'postgres_scanner', 'iceberg', 'vss', 'fts', 'httpfs', 'arrow', 'tpcds', 'delta', 'inet', 'sqlite_scanner', 'excel']
None of extensions had failed to be installed or loaded.
